...
class Cointopay_IbanCointopay_ValidationModuleFrontController extends ModuleFrontController
{
    public $ssl = true;
    ...
    public function initContent()
    {
        ...
        try {
            if ($ctp_response != '') {
                ...
                if (_PS_VERSION_ >= '1.7') {
                    $this->setTemplate('module:cointopay_iban/views/templates/front/ctp_validation_failed.tpl');
                } else {
